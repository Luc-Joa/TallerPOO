 ...
 * @author Joaquin
 */
public class VentanaSimulacionn extends javax.swing.JFrame {
...
//se dibuja la imagen que tenemos en el paquete Images dentro de un panel
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaSimulacionn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaSimulacionn().setVisible(true);
            }
        });
    }
