 ...
 * @author Joaquin
 */
public class VentanaIngresoo extends javax.swing.JFrame {

    /**
     * Creates new form VentanaIngresoo
     */
    public VentanaIngresoo() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaIngresoo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaIngresoo().setVisible(true);
            }
        });
    }
